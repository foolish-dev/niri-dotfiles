...
cd ~/dotfiles
./install.sh                                                          # cargo-installs grogu, builds HexStrike under ~/tools/hexstrike-ai, pacman-installs Noctalia on Arch
...
install.sh                                # bootstrap grogu + HexStrike + Noctalia
```
